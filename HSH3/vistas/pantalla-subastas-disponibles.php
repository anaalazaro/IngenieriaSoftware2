    ...
    <table class="table table-striped uk-table uk-table-divider uk-align-center">
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <td><a href="../controladores/modificarResidencia.php?nom_residencia=<?php echo $nom_residencia ?>">Subastar<span class="uk-icon uk-icon-image" style="background-image: url('../files/martillo.svg');" ></span></a></td>
        <?php } ?>
        </tr>
      </tbody>
    </table>
