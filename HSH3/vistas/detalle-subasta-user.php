           ...
           if($paquete['estado']=='SUBASTA') {?>
             ...
             <div class="toggle uk-padding uk-padding-remove-horizontal" hidden>
               ...
               <form class="" action="../controladores/controlSubasta.php?id_paquete=<?php echo $paquete['id'] ?>" method="post">
                 <input type="number" name="nuevo-precio" value="" min="<?php echo $puja_minima ?>" placeholder="Minima puja de $<?php echo $puja_minima; ?>" class="uk-input uk-width-1-1" required>
