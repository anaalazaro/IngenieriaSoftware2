...
function modificarEstado(){
	...
	while ($row = mysqli_fetch_array($result)){
		...
		echo " paquete= ".$dt."actual= ".$fecha." subasta=: ".$dt_subasta_inicio. " fin subasta= ".$dt_subasta_fin."<br>";
		if ($estado=='ACTIVO' AND ($fecha>=$dt_subasta_inicio AND $fecha<=$dt_subasta_fin)){
			echo " paquete= ".$dt."actual= ".$fecha." subasta=: ".$dt_subasta_inicio. " fin subasta= ".$dt_subasta_fin;
			echo "Subasta <br>";
